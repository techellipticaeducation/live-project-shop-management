...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("All Items", jScrollPane1);
        setTable();
        ...
        jLabel7.setText("Rs 1 * ");
        jLabel7.setVerticalAlignment(javax.swing.SwingConstants.TOP);

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Total Amount Return");
        ...
        jLabel9.setText("Tech-Elliptica");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	double itemPrice = Double.parseDouble(jTextField2.getText().toString());
    	int itemQuantity = Integer.parseInt(jComboBox1.getSelectedItem().toString());
    	CustomCalculation.addItem(itemName, itemPrice, itemQuantity);
    	setTable();
    ...
    public void setTable() {
    	List<Item> allItems = CustomCalculation.allItems;
    	System.out.println(allItems.size());
    	Object[][]  ar = new Object[allItems.size()][4];
    	...
    	jTable1.setModel(new javax.swing.table.DefaultTableModel(
    			ar,
                new String [] {
                    "ItemName", "Quantity", "ItemPrice/Unit", "Total"
                }
            ));
            jScrollPane1.setViewportView(jTable1);

            
            jLabel12.setText("Total : " + CustomCalculation.totalPrice+" /-");
    }
